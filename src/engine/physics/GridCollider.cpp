...
const int GridCollider::CLASS_ID = 1;

int GridCollider::getClassID()
{
	return CLASS_ID;
}

GridCollider::GridCollider(std::vector<std::vector<bool>> &map, int nx, int ny,
...
glm::vec4 GridCollider::boundingBox(glm::mat4 &matrix)
{
	double coords[4][2];
